...
.. slug: 27-languages-to-improve-your-python
...
2. Refrain from adopting attitudes of contempt towards other open source
   ...
   decisions), so ensuring we're helping people to solve problems independently
   of technology vendors is one small step we can take as developers.
...
Wordpress blogging engine, and the MediaWiki engine that powers Wikipedia.
...
What it *is* likely to do to is to provide some insight into how programming
language distribution and adoption actually works, and how much that has to do
with fortuitous opportunities, accidents of history and lowering barriers to
